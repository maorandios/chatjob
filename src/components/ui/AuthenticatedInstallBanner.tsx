...
const WORKER_INSTALL_LABELS: Record<LanguageCode, InstallAppSheetLabels> = {
  ...
  uz: {
    title: "Kling ni o'rnating",
    iosTitle: "iPhone ga o'rnatish",
    iosSubtitle: "Ulashish menyusini oching va Kling ni bosh ekranga qo'shing.",
    iosStepShare: "Brauzerda Share tugmasini bosing",
    iosStepHome: "Add to Home Screen ni tanlang",
    iosStepDone: "Tasdiqlang va Kling ni bosh ekrandan oching",
    androidTitle: "Android ga o'rnatish",
    androidReady: "Kling ni to'g'ridan-to'g'ri bosh ekranga o'rnatishingiz mumkin.",
    androidUnavailable: "Agar o'rnatish tugmasi ko'rinmasa, brauzer menyusini ochib Install app yoki Add to Home screen ni tanlang.",
    androidButton: "Kling ni o'rnatish",
    laterButton: "Keyinroq",
  },
  vi: {
    title: "Cài đặt Kling",
    iosTitle: "Cài đặt trên iPhone",
    iosSubtitle: "Mở menu chia sẻ và thêm Kling vào màn hình chính.",
    iosStepShare: "Nhấn nút Share trong trình duyệt",
    iosStepHome: "Chọn Add to Home Screen",
    iosStepDone: "Xác nhận rồi mở Kling từ màn hình chính",
    androidTitle: "Cài đặt trên Android",
    androidReady: "Bạn có thể cài Kling trực tiếp vào màn hình chính.",
    androidUnavailable: "Nếu nút cài đặt không xuất hiện, hãy mở menu trình duyệt và chọn Install app hoặc Add to Home screen.",
    androidButton: "Cài đặt Kling",
    laterButton: "Để sau",
  },
  az: {
    title: "Kling quraşdırın",
    iosTitle: "iPhone-da quraşdırın",
    iosSubtitle: "Paylaşma menyusunu açın və Kling-i əsas ekrana əlavə edin.",
    iosStepShare: "Brauzerdə Share düyməsinə toxunun",
    iosStepHome: "Add to Home Screen seçin",
    iosStepDone: "Təsdiqləyin və Kling-i əsas ekrandan açın",
    androidTitle: "Android-də quraşdırın",
    androidReady: "Kling-i birbaşa əsas ekrana quraşdıra bilərsiniz.",
    androidUnavailable: "Quraşdırma düyməsi görünmürsə, brauzer menyusunu açın və Install app və ya Add to Home screen seçin.",
    androidButton: "Kling quraşdırın",
    laterButton: "Sonra",
  },
  ar: {
    title: "تثبيت Kling",
